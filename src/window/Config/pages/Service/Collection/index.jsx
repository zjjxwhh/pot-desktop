...
import { Surface, Button, useOverlayState } from '@heroui/react';
...
export default function Collection(props) {
    ...
    return (
        <>
            <Surface className={'h-full overflow-y-auto p-4 flex flex-col gap-3 justify-between rounded-[min(32px,var(--radius-3xl))] shadow-surface'}>
