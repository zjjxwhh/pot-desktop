    ...
    return (
        config !== null && (
            ...
            >
                ...
                <div className={'config-item'}>
                    <h3 className='my-auto'>{t('services.recognize.baidu_accurate_ocr.client_id')}</h3>
                    <TextField
                ...
                <div className={'config-item'}>
                    <h3 className='my-auto'>{t('services.recognize.baidu_accurate_ocr.client_secret')}</h3>
                    <TextField
