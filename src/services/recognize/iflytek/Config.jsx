    ...
    return (
        config !== null && (
            ...
            >
                ...
                <div className={'config-item'}>
                    <h3 className='my-auto'>{t('services.recognize.iflytek_ocr.appid')}</h3>
                    <TextField
                        value={config['appid']}
                        onChange={(value) => {
                            setConfig({
                ...
                <div className={'config-item'}>
                    <h3 className='my-auto'>{t('services.recognize.iflytek_ocr.apisecret')}</h3>
                    <TextField
                ...
                <div className={'config-item'}>
                    <h3 className='my-auto'>{t('services.recognize.iflytek_ocr.apikey')}</h3>
                    <TextField
                        value={config['apikey']}
                        onChange={(value) => {
                            setConfig({
