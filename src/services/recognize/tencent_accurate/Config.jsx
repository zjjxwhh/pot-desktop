    ...
    return (
        config !== null && (
            ...
            >
                ...
                <div className={'config-item'}>
                    <h3 className='my-auto'>{t('services.recognize.tencent_accurate_ocr.secret_id')}</h3>
                    <TextField
                ...
                <div className={'config-item'}>
                    <h3 className='my-auto'>{t('services.recognize.tencent_accurate_ocr.secret_key')}</h3>
                    <TextField
